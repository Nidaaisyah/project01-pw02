                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header"> 
                            <h3 class="card-title">Edit Form unit_kerja </h3>
                        ...
                        <div class="card-body">
                            <h2 class="text-center">Form unit_kerja </h2>
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                </div>
                                <div class="form-group row">
                                    <label class="col-4 col-form-label">Nama</label>
                                    <div class="col-8">
                                        <select id="unit_kerja_id" name="unit-kerja_id" class="custom-select">
                                            <?php
                                            $sqljenis = "SELECT * FROM unit_kerja";
                                            $rsjenis = $dbh->query($sqljenis);
                                            foreach ($rsjenis as $rowjenis) {
                                                $selected = ($row['unir_kerja_id'] == $rowjenis['id']) ? 'selected' : '';
