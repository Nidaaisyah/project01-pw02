                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <select id="kategori" name="kategori" class="form-control">
                                            <?php
                                            $enum_values = ['Umum', 'Spesialis', 'Bidan', 'Dokter Gigi', 'Anastesi', 'Bedah', 'Ginekolog'];
                                            foreach ($enum_values as $value) {
                                                // Tandai opsi yang sesuai dengan nilai yang disimpan di database
                                                $selected = ($value == $row['kategori']) ? 'selected' : '';
